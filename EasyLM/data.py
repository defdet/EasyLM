...
class HuggingfaceDataset(object):
    ...
    def __init__(self, config, tokenizer, text_processor):
        ...
        ds_culturax_eng = load_dataset("uonlp/CulturaX", "en", split='train', cache_dir='../gemma_modeling/datasets',  use_auth_token=True, streaming=True).take(400_000_000).remove_columns(["timestamp", "url", "source"])
        ds_culturax_ru = load_dataset("uonlp/CulturaX", "ru", split='train', cache_dir='../gemma_modeling/datasets',  use_auth_token=True, streaming=True).take(800_000_000).remove_columns(["timestamp", "url", "source"])
